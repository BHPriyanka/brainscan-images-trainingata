...
job.name=ClassificationModel
training.jar.name=training-data-0.0.1-SNAPSHOT.jar
training.jar.path=target/${training.jar.name}
training.job.name=ClassificationModel
local.input=input
local.output=output
...
aws.bucket.name=priyanka-training-bucket
